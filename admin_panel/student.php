                ...
                <div class="modal-body">
                    <div class="container my-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control remove_student_id" id="student-id"
            ...
            <div class="orders">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item me-1" role="presentation">
                        <button class="nav-link active " id="addStudentTab" data-bs-toggle="tab" data-bs-target="#home"
                            onclick="AddStudentBtnClick()" type="button" role="tab" aria-controls="home"
                            aria-selected="true">Add Students</button>
                    </li>
                    <li class="nav-item me-1" role="presentation">
                        <button class="nav-link" id="view-students-tab" data-bs-toggle="tab" data-bs-target="#profile"
                            type="button" role="tab" aria-controls="profile" aria-selected="false"
                            onclick="showStudents()">Show
                            Students</button>
                    </li>
                    <li class="nav-item me-1" role="presentation">
                        ...
                        <div class="attendenceTable" style="display: block;">
                                    ...
                                    <div class="dropdown dropdown-center">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item reset-attendence" id="add_student_dropdown"
                                                    ...
                                                    Student</a></li>
                                            <li><a class="dropdown-item submit-attendence" id="remove_student_dropdown"
                                                    data-bs-toggle="modal" data-bs-target="#removeStudentModel">Remove
                                                    Student</a></li>
                                        </ul>
                                    </div>
                            ...
                            <div class="container add-remove">
                                <ul class="insights">
                                    ...
                                    <a class="removelink" id="remove-student-jumbo-btn" data-bs-toggle="modal"
                                        data-bs-target="#removeStudentModel">
                                        <li class="removeitem">
